...
class LtePhyBase : public ChannelAccess
{
  ...
  protected:
    ...
    static simsignal_t averageMCSDlSignal_;
    static simsignal_t averageMCSUlSignal_;
    static simsignal_t averageTBSDlSignal_;
    static simsignal_t averageTBSUlSignal_;
