...
class LtePhyUe : public LtePhyBase
{
  protected:
    ...
    // Support to print average MCS at the end of the simulation
    std::vector<short int> mcsDlSamples_;
    std::vector<short int> mcsUlSamples_;
    unsigned int mcsDlSum_ = 0;
    unsigned int mcsUlSum_ = 0;
    unsigned int mcsDlCount_ = 0;
    unsigned int mcsUlCount_ = 0;

    // Support to print average TBS at the end of the simulation
    std::vector<short int> tbsDlSamples_;
    std::vector<short int> tbsUlSamples_;
    unsigned int tbsDlSum_ = 0;
    unsigned int tbsUlSum_ = 0;
    unsigned int tbsDlCount_ = 0;
    unsigned int tbsUlCount_ = 0;
  ...
  public:
    ...
    void recordMCS(unsigned int sample, Direction dir);
    void recordTBS(unsigned int sample, Direction dir);
    double getAverageCqi(Direction dir);
    double getAverageMCS(Direction dir);
    double getAverageTBS(Direction dir);
    double getVarianceCqi(Direction dir);
    double getVarianceMCS(Direction dir);
    double getVarianceTBS(Direction dir);
};
