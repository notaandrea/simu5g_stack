...
simsignal_t LtePhyBase::averageMCSDlSignal_ = registerSignal("averageMCSDl");
simsignal_t LtePhyBase::averageMCSUlSignal_ = registerSignal("averageMCSUl");
simsignal_t LtePhyBase::averageTBSDlSignal_ = registerSignal("averageTBSDl");
simsignal_t LtePhyBase::averageTBSUlSignal_ = registerSignal("averageTBSUl");
