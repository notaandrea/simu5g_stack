...
const MacNodeId& D2DModeSwitchNotification::getPeerId() const
{
    return this->peerId;
}

void D2DModeSwitchNotification::setPeerId(const MacNodeId& peerId)
{
    handleChange();
    this->peerId = peerId;
}
...
std::string D2DModeSwitchNotificationDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    D2DModeSwitchNotification *pp = omnetpp::fromAnyPtr<D2DModeSwitchNotification>(object); (void)pp;
    switch (field) {
        case FIELD_peerId: return "";
        case FIELD_txSide: return bool2string(pp->getTxSide());
        case FIELD_oldMode: return enum2string(pp->getOldMode(), "simu5g::LteD2DMode");
        case FIELD_newMode: return enum2string(pp->getNewMode(), "simu5g::LteD2DMode");
...
omnetpp::cValue D2DModeSwitchNotificationDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    D2DModeSwitchNotification *pp = omnetpp::fromAnyPtr<D2DModeSwitchNotification>(object); (void)pp;
    switch (field) {
        case FIELD_peerId: return omnetpp::toAnyPtr(&pp->getPeerId()); break;
