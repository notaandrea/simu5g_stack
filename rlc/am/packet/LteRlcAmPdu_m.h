...
/**
 * Class generated from <tt>stack/rlc/am/packet/LteRlcAmPdu.msg:27</tt> by opp_msgtool.
 * <pre>
...
template<> inline simu5g::LteRlcAmPdu_Base *fromAnyPtr(any_ptr ptr) { return check_and_cast<simu5g::LteRlcAmPdu_Base*>(ptr.get<cObject>()); }
