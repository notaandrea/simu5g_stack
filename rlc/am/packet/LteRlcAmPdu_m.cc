//
// Generated file, do not edit! Created by opp_msgtool 6.1 from stack/rlc/am/packet/LteRlcAmPdu.msg.
//
...
LteRlcAmPduDescriptor::LteRlcAmPduDescriptor() : omnetpp::cClassDescriptor("simu5g::LteRlcAmPdu", "LteRlcPdu")
{
...
std::string LteRlcAmPduDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    LteRlcAmPdu_Base *pp = omnetpp::fromAnyPtr<LteRlcAmPdu_Base>(object); (void)pp;
    switch (field) {
        case FIELD_amType: return enum2string(pp->getAmType(), "simu5g::LteAmType");
